...
import com.assistant.conversation.model.NonAgenticGuidedConversation;
import com.assistant.conversation.model.Plan;
...
public class ChatHistoryService {
    ...
    public Conversation patch(String id, ConversationPatch patch, ConversationValidator validator) {
        ...
        existing.setUpdatedAt(System.currentTimeMillis() / 1000L);
