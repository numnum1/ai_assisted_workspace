package com.assistant.context;

import com.assistant.config.AppConfig;
import com.assistant.conversation.utils_to_replace.GuidedSessionPrompts;
import com.assistant.file_services.FileService;
import com.assistant.meta_files.ChapterService;
...
import com.assistant.project_outliner.FileNode;
import com.assistant.file_services.ReferenceResolver;
...
public class ContextService {
    ...
    public AssembledContext assemble(ChatRequest request) {
        ...
        if (projectConfigService.hasProjectConfig()) {
            WorkspaceModeSchema wsMode = projectConfigService.getWorkspaceModeSchema();
    ...
    private void appendTreeListing(StringBuilder sb, FileNode node, String indent) {
