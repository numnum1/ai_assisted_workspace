...
import type { ChapterNode, ChapterSummary, ScrollTarget, SelectionContext, AltVersionSession, ChapterComment, CommentCategory, CommentCategoryDef, UserChapterSelection, NodeMeta, MetaSelection, MetaNodeType } from '../../../../shared/types.ts';
...
import { chapterApi, projectConfigApi } from '../../../../shared/api.ts';
